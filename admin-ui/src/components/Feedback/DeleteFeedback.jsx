...
const DeleteCategoryPopup = ({ feedback = "this feedback", onConfirm, onCancel }) => {
                ...
                <div className="p-6">
                    ...
                    <div className="mt-4 text-center">
                        ...
                        <p className="mt-2 text-sm text-gray-500">
                            Are you sure you want to delete <span className='font-semibold'>{feedback?.charAt(0).toUpperCase() + feedback?.slice(1)}</span>? This action cannot be undone. 
                        </p>
                    </div>
