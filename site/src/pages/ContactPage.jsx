...
const ContactPage = () => {
    ...
    <div className="max-w-full mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12 pt-8 lg:pt-16 mt-6 lg:mt-10 pb-8 lg:pb-16 mb-6 lg:mb-10">
        ...
        >
            ...
            <div className="space-y-6 lg:space-y-7">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="font-semibold text-lg sm:text-xl">Head Office</h3>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="font-semibold text-lg sm:text-xl">Email Support</h3>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="font-semibold text-lg sm:text-xl">Let's Talk</h3>
        ...
        <div
            className="bg-neutral-900 w-full lg:w-[55%] border border-zinc-600 rounded-2xl py-6 sm:py-8 px-6 sm:px-8 lg:px-10 opacity-0"
            style={{
