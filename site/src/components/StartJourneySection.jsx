...
const StartJourneySection = () => {
  ...
  return (
    <div
      ref={ref}
      className="relative w-full h-[66vh] max-h-screen overflow-hidden"
    >
      {/* Background Image */}
      <div
      ...
      <div className="relative flex items-center justify-center md:justify-end px-4 md:px-8 lg:px-16 w-full h-full">
        ...
        >
          <h2 className="text-2xl md:text-4xl text-white mb-2 px-3">
            ...
            <span className="text-emerald-400"> Let’s Work</span> Together!
          </h2>

          <p className="text-gray-300 my-6 text-md md:text-base">
            Smart, scalable, and effective digital solutions for lasting
            success. Reach out today and start your journey.
          </p>
