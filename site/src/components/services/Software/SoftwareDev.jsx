...
import Software_development_outsourcing from "../../../assets/services_images/software_services/Software-development-outsourcing.jpg";
    ...
    <div className="min-h-screen bg-[#151515] text-white">
      ...
      >
        <section className="text-center py-32">
          ...
          >
            Software <span className="text-[#5CDA92]">Developement</span>
          </motion.h1>
          <motion.p
      ...
      >
        <div className="w-full min-h-[70vh] md:min-h-[100vh] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 ">
          ...
          <motion.div className="relative hidden overflow-hidden md:flex md:justify-center">
            ...
            >
              <img
                src={Software_development_outsourcing}
                alt="Why Choose Us"
