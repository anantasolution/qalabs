...
import IMAGE from "../../../assets/services_images/software_services/automation_testing.jpeg";
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          ...
          progressControls.start({ strokeDasharray: "96, 100" }); // Animate the progress circle
        } else {
          controls.start("hidden"); // Optionally, reverse animations when out of view
          progressControls.start({ strokeDasharray: "96, 0" });
        }
      },
    ...
    <div className="min-h-screen bg-[#151515] text-white">
      ...
      >
        <section className="text-center py-32">
          ...
          >
            Automation <span className="text-[#5CDA92]">Testing</span>
          </motion.h1>
          <motion.p
