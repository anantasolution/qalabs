    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          ...
          progressControls.start({ strokeDasharray: "94, 100" }); // Animate the progress circle
        } else {
          controls.start("hidden"); // Optionally, reverse animations when out of view
          progressControls.start({ strokeDasharray: "94, 0" });
        }
      },
    ...
    <div className="min-h-screen bg-[#151515] text-white">
      ...
      >
        <section className="text-center py-32">
          ...
          >
            Software <span className="text-[#5CDA92]">Licensing</span>
          </motion.h1>
          <motion.p
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-24">
            ...
            >
              ...
              <p className="text-gray-400 text-md leading-relaxed">
                Ensure smooth software deployment with the correct licensing
                solutions. ZyinexWeb provides businesses with genuine software
                licenses that ensure compliance, security, and seamless
                operations.
              </p>
            </motion.div>
        ...
        <div className="w-full min-h-[70vh] md:min-h-[100vh] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 ">
          ...
          >
            ...
            <p className="text-[#828282] text-md md:text-xl">
              We help businesses access legally licensed software from
              industry-leading providers. Our solutions include volume
              licensing, subscription models, and custom licensing agreements to
              meet your business needs.
            </p>
            <p className="text-[#828282] text-md md:text-xl">
              By choosing verified software licenses, businesses can avoid
              compliance risks and ensure smooth IT operations. Our team assists
              in selecting the right software packages that align with your
