...
import IMAGE from "../../../assets/services_images/software_services/Archived-data-for-analytics.jpg";
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          ...
          progressControls.start({ strokeDasharray: "88, 100" }); // Animate the progress circle
        } else {
          controls.start("hidden"); // Optionally, reverse animations when out of view
          progressControls.start({ strokeDasharray: "88, 0" });
        }
      },
    ...
    <div className="min-h-screen bg-[#151515] text-white">
      ...
      >
        <section className="text-center py-32">
          ...
          >
            Data <span className="text-[#5CDA92]">Analytics</span>
          </motion.h1>
          <motion.p
