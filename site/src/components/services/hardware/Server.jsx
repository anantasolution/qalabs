...
import services_serverinstall from "../../../assets/services_images/hardware_services/services_serverinstall.jpg";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-24">
            ...
            >
              <h2 className="text-4xl md:text-[40px] leading-tight text-white">
                Powerful Server Installations for
              ...
              <p className="text-gray-400 text-md leading-relaxed">
                Ensure easy operation and data protection with high-performance
                server installations. At ZyinexWeb, we are experts in setting up
                customised server solutions that support scalability, data
                management and security for businesses of all sizes.
              </p>
            </motion.div>
        ...
        <div className="w-full min-h-[70vh] md:min-h-[100vh] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 ">
          ...
          >
            ...
            <p className="text-[#828282] text-md md:text-xl">
              A powerful and secure server is important for data storage,
              professional applications and seamless communication. We offer a
              dedicated, cloud-based and hybrid server installation by ensuring
              maximum uptime and data protection. Dictumst porta ultricies
              tristique hac vestibulum himenaeos ligula. Cubilia sapien torquent
              at finibus accumsan et pellentesque class lacinia tristique.
            </p>
            <p className="text-[#828282] text-md md:text-xl">
              Our IT experts evaluate your business needs and establish
              scalable, cost-effective and high-performance servers that
              increase with your company. With continuous monitoring, regular
              updates, and 24/7 support, we ensure that your data servers are
              safe, optimised, and always available.
            </p>
          </motion.div>
