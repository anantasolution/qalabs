...
import services_networksolution from "../../../assets/services_images/hardware_services/services_networksolution.jpg";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-24">
            ...
            >
              ...
              <p className="text-gray-400 text-md leading-relaxed">
                Empower your business with advanced networking solutions
                designed for high-speed, secure and scalable communication. At
                ZyinexWeb, we offer customized network setups to ensure simple
                data flow, strong security and minimal downtime.
              </p>
            </motion.div>
        ...
        <div className="w-full min-h-[70vh] md:min-h-[100vh] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 ">
          ...
          >
            ...
            <p className="text-[#828282] text-md md:text-xl">
              A well-structured network is required for professional business
              continuity and efficiency. Our solutions include wired and
              wireless networking, VPN setups and firework security to protect
              and trim to protect your performance and operations.
            </p>
            <p className="text-[#828282] text-md md:text-xl">
              We design and implement tailor-made networking solutions for
              businesses of all sizes, ensuring seamless connectivity, secure
              data transfer, and maximum productivity. With reliable hardware,
              specialist setup, and continuous support, we keep your network
