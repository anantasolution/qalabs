    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          ...
          progressControls.start({ strokeDasharray: "91, 100" }); // Animate the progress circle
        } else {
          controls.start("hidden"); // Optionally, reverse animations when out of view
          progressControls.start({ strokeDasharray: "91, 0" });
        }
      },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-24">
            ...
            >
              <h2 className="text-4xl md:text-[40px] leading-tight text-white">
                Effortless IT Infrastructure Management for
              ...
              <p className="text-gray-400 text-md leading-relaxed">
                Keep your business running smoothly with reliable IT maintenance
                services that prevent downtime and optimise performance. At
                ZyinexWeb, our Annual Maintenance Contracts (AMC) ensure your IT
                hardware and software remain secure, updated, and fully
                functional.
              </p>
            </motion.div>
