...
const Cards = () => {
    ...
    const services = [
        {
            ...
            title: 'Web Design',
            description: 'Auctor dictumst inceptos metus est ad himenaeos habitasse litora natoque libero nunc'
        },
        {
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="black" className="size-6">
    ...
    return (
        <motion.div
            className="min-h-screen bg-neutral-900 text-white p-4 md:p-8 flex justify-center items-center"
            style={{
